...
namespace StarterAssets
{
    ...
    public class ThirdTest : MonoBehaviour
    {
        ...
        {
            if (_input.Lattack && !_input.Rattack)
            {
                Debug.Log("ataque derecho"); //ataque hecho por mi
                _animator.SetBool(_animL, true);
            ...
            {
                Debug.Log("ataque izquierdo"); //ataque hecho por mi
            ...
            if (_input.Rattack && _input.Lattack)
            {
                Debug.Log("ataque COMBO WOMBO"); //ataque hecho por mi
